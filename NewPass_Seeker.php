...
<head>
    ...
    <title>ByteMe | New Password Reset - Seeker</title>
    ...
    <div class="container">
        ...
        <form action="LogIn_Seeker.php" method="post">
            ...
            <div class="form-group-btn text-center">
                <input type="submit" name="changePassword" value="Save" class="btn btn-primary">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="text-right">
                    <div> <a href="ForgotPass_Seeker.php" style="font-size: 14px;">Forgot password?</a></div>
                </div>
            </div>
            <div class="form-group-btn text-center">
